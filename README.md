...
<div style="text-align: center;">
  ...
  <p style="margin-top: 8px; font-size: 14px; font-weight: normal;">
    <b>Figure 3:</b> <b>Left:</b> mean training loss across iterations for the expected perturbation samples. The monotonic increase indicates that <b> the learned policy produces progressively stronger perturbations, suggesting stable optimization</b>.
